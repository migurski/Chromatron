        ...
        return (
            <form style={{display: 'block', float: 'right', width: 180, height: '100%', padding: 18, background: 'rgba(255,255,255,.8)'}}>
                <div style={{height: 50, background: fill.hex()}} />
                    <h3>RGB</h3>
                    <Range key="rgb.r" name="rgb.r" label="R" value={rgb[0]} min="0" max="255" form={form} />
                    <Range key="rgb.g" name="rgb.g" label="G" value={rgb[1]} min="0" max="255" form={form} />
                    <Range key="rgb.b" name="rgb.b" label="B" value={rgb[2]} min="0" max="255" form={form} />
            </form>
            )
    }
}
